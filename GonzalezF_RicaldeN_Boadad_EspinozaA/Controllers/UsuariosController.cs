...
namespace GonzalezF_RicaldeN_Boadad_EspinozaA.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public UsuariosController(BDDChatContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] Usuario usuario)
        {
            if (id != usuario.Id)
            {
                return NotFound();
